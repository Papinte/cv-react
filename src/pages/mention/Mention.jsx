...
const Mention = () => {
  return (
    <body>
      <div>
        <h1 className="mention text-uppercase text-center">mentions légales</h1>
          ...
          >
            <div class="accordion-body">
              ...
              <address>
                ...
                <span class="text-primary">06 20 30 40 50</span>
                <br />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                ...
                <span class="text-primary">john.doe@gmail.com</span>
                <br />
              </address>
            </div>
          </div>
          ...
          >
            <div class="accordion-body">
              ...
              <address>
                ...
                <span class="text-primary">www.alwaysdata.com</span>
              </address>
            </div>
          </div>
        </div>
          ...
          >
            <div class="accordion-body">
              ...
              <p>
                ...
                <span class="text-primary">Pixabay</span>.
              </p>
            </div>
          </div>
        </div>
