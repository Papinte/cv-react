          ...
          >
            <div class="accordion-body">
              ...
              <address>
                ...
                <span class="text-primary">06 20 30 40 50</span><br />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                ...
                <span class="text-primary">john.doe@gmail.com</span><br />
              </address>
            </div>
          </div>
        </div>
          ...
          >
            <div class="accordion-body">
              ...
              <address>
                ...
                </svg> <span class="text-primary">www.alwaysdata.com</span>
              </address>
            </div>
          </div>
        </div>
        <div class="accordion-item">
          ...
          >
            <div class="accordion-body">
                ...
                <p>Les images libres de droit sont issues du site <span class="text-primary">Pixabay</span>.</p>
            </div>
          </div>
        </div>
      </div>
