...
const Home = () => {
    return (
            <body>
                ...
                <div id="text-banner" className="container text-center position-absolute top-50 start-50 translate-middle">
                ...
                <div id="about" className="about container row mx-auto my-5 rounded p-5 shadow-lg p-3 mb-5 bg-body rounded">
                    <div className="col-md-6">
                        <h3 className="pb-2 mb-4 border-bottom border-primary border-2">À propos</h3>
